 ...
 */
class TFTView_480x800 : public MeshtasticView
{
  public:
  ...
  private:
    ...
    static TFTView_480x800 *instance(void);
    static TFTView_480x800 *instance(const DisplayDriverConfig &cfg);
    TFTView_480x800();
    TFTView_480x800(const DisplayDriverConfig *cfg, DisplayDriver *driver);
    ...
    static TFTView_480x800 *gui;                     // singleton pattern
