#if HAS_TFT && defined(VIEW_480x800)

#include "graphics/view/TFT/TFTView_480x800.h"
#include "Arduino.h"
...
#define THIS TFTView_480x800::instance() // need to use this in all static methods
...
TFTView_480x800 *TFTView_480x800::gui = nullptr;
lv_obj_t *TFTView_480x800::currentPanel = nullptr;
lv_obj_t *TFTView_480x800::spinnerButton = nullptr;
uint32_t TFTView_480x800::currentNode = 0;
time_t TFTView_480x800::startTime = 0;
uint32_t TFTView_480x800::pinKeys = 0;
bool TFTView_480x800::screenLocked = false;
bool TFTView_480x800::screenUnlockRequest = false;
TFTView_480x800::KbdSlide TFTView_480x800::kbdSlideState = TFTView_480x800::eKbdHidden;
int32_t TFTView_480x800::kbdPanelBaseY = INT32_MIN;
...
TFTView_480x800 *TFTView_480x800::instance(void)
{
    if (!gui) {
        gui = new TFTView_480x800(nullptr, DisplayDriverFactory::create(480, 800));
    }
    return gui;
}

TFTView_480x800 *TFTView_480x800::instance(const DisplayDriverConfig &cfg)
{
    if (!gui) {
        gui = new TFTView_480x800(&cfg, DisplayDriverFactory::create(cfg));
    }
    return gui;
}

TFTView_480x800::TFTView_480x800(const DisplayDriverConfig *cfg, DisplayDriver *driver)
 ...
 */
void TFTView_480x800::init(IClientBase *client)
{
    ILOG_DEBUG("TFTView_480x800 init...");
    ILOG_DEBUG("TFTView_480x800 db size: %d", sizeof(TFTView_480x800));
 ...
 */
bool TFTView_480x800::setupUIConfig(const meshtastic_DeviceUIConfig &uiconfig)
{
 ...
 */
void TFTView_480x800::updateBootMessage(const char *msg)
{
    if (msg)
 ...
 *
 */
void TFTView_480x800::init_screens(void)
{
    ...
    ILOG_DEBUG("TFTView_480x800 init done.");
}
 ...
 */
void TFTView_480x800::ui_set_active(lv_obj_t *b, lv_obj_t *p, lv_obj_t *tp)
{
    if (activeButton) {
...
void TFTView_480x800::enterProgrammingMode(void)
{
 ...
 *
 */
void TFTView_480x800::apply_hotfix(void)
{
...
void TFTView_480x800::updateTheme(void)
{
    Themes::initStyles();
...
void TFTView_480x800::ui_events_init(void)
{
    ...
    auto ui_event_HomeButton = [](lv_event_t *e) {
        ...
        if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
            TFTView_480x800 &view = *static_cast<TFTView_480x800 *>(e->user_data);
...
void TFTView_480x800::timer_event_reboot(lv_timer_t *timer)
{
    ILOG_INFO("Rebooting...");
...
void TFTView_480x800::timer_event_shutdown(lv_timer_t *timer)
{
    ILOG_INFO("Shutdown...");
    THIS->controller->stop();
    delay(1000);
...
void TFTView_480x800::timer_event_programming_mode(lv_timer_t *timer)
{
...
void TFTView_480x800::ui_event_LogoButton(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_BluetoothButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_NodesButton(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_NodeButton(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_GroupsButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
void TFTView_480x800::ui_event_ChannelButton(lv_event_t *e)
{
    static bool ignoreClicked = false;
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
void TFTView_480x800::ui_event_MessagesButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
        if (THIS->messagesRestored) {
...
void TFTView_480x800::ui_event_MapButton(lv_event_t *e)
{
    static bool ignoreClicked = false;
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
void TFTView_480x800::ui_event_SettingsButton(lv_event_t *e)
{
    static bool ignoreClicked = false;
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_ChatButton(lv_event_t *e)
{
    static bool ignoreClicked = false;
    lv_event_code_t event_code = lv_event_get_code(e);
 ...
 * @param e
 */
void TFTView_480x800::ui_event_ChatDelButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
        lv_obj_t *target = lv_event_get_target_obj(e);
 ...
 *
 */
void TFTView_480x800::ui_event_MsgPopupButton(lv_event_t *e)
{
    lv_obj_t *target = lv_event_get_target_obj(e);
 ...
 *
 */
void TFTView_480x800::ui_event_MsgRestoreButton(lv_event_t *e)
{
    lv_obj_add_flag(objects.msg_restore_panel, LV_OBJ_FLAG_HIDDEN);
}

void TFTView_480x800::ui_event_EnvelopeButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
        if (!THIS->messagesRestored) {
...
void TFTView_480x800::ui_event_AlertButton(lv_event_t *e)
{
    lv_obj_add_flag(objects.alert_panel, LV_OBJ_FLAG_HIDDEN);
}

void TFTView_480x800::ui_event_OnlineNodesButton(lv_event_t *e)
{
    static bool ignoreClicked = false;
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_TimeButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_LoRaButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_BellButton(lv_event_t *e)
{
    static bool ignoreClicked = false;
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_LocationButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_WLANButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_MQTTButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_SDCardButton(lv_event_t *e)
{
    static bool ignoreClicked = false;
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_MemoryButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_QrButton(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_CancelQrButton(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_BlankScreenButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_KeyboardButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
 ...
 */
void TFTView_480x800::ui_event_Keyboard(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_message_ready(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_user_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
void TFTView_480x800::ui_event_role_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_region_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_preset_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_wifi_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_language_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
void TFTView_480x800::ui_event_channel_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
void TFTView_480x800::ui_event_brightness_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
        char buf[20];
...
void TFTView_480x800::ui_event_theme_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
void TFTView_480x800::ui_event_calibration_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_timeout_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
void TFTView_480x800::ui_event_screen_lock_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
        char buf[10];
...
void TFTView_480x800::ui_event_input_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
void TFTView_480x800::ui_event_alert_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
// backup & restore
void TFTView_480x800::ui_event_backup_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
// configuration reset
void TFTView_480x800::ui_event_reset_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
// reboot / shutdown
void TFTView_480x800::ui_event_reboot_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
        lv_obj_remove_flag(objects.boot_logo_button, LV_OBJ_FLAG_HIDDEN);
...
void TFTView_480x800::ui_event_about_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED && THIS->activeSettings == eNone) {
...
void TFTView_480x800::ui_event_device_reboot_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_device_progmode_button(lv_event_t *e)
{
    static bool ignoreClicked = false;
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_device_shutdown_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_device_cancel_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_modify_channel(lv_event_t *e)
{
    static bool ignoreClicked = false;
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_generate_psk(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_qr_code(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_delete_channel(lv_event_t *e)
{
    lv_textarea_set_text(objects.settings_modify_channel_psk_textarea, "");
    lv_textarea_set_text(objects.settings_modify_channel_name_textarea, "");
}

void TFTView_480x800::ui_event_calibration_screen_loaded(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_pin_screen_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void TFTView_480x800::ui_event_backup_restore_radio_button(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_zoomSlider(lv_event_t *e)
{
    THIS->map->setZoom(lv_slider_get_value(objects.zoom_slider));
    THIS->updateLocationMap(THIS->map->getObjectsOnMap());
}

void TFTView_480x800::ui_event_zoomIn(lv_event_t *e)
{
    THIS->map->setZoom(MapTileSettings::getZoomLevel() + 1);
    THIS->updateLocationMap(THIS->map->getObjectsOnMap());
}

void TFTView_480x800::ui_event_zoomOut(lv_event_t *e)
{
    THIS->map->setZoom(MapTileSettings::getZoomLevel() - 1);
    THIS->updateLocationMap(THIS->map->getObjectsOnMap());
}

void TFTView_480x800::ui_event_lockGps(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_mapBrightnessSlider(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_mapContrastSlider(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_map_style_dropdown(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_map_url_dropdown(lv_event_t *e)
{
    char url[128];
 ...
 */
void TFTView_480x800::ui_event_map_url_textarea(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_KEY) {
        uint32_t *key = (uint32_t *)lv_event_get_param(e);
...
void TFTView_480x800::ui_event_mapNodeButton(lv_event_t *e)
{
...
void TFTView_480x800::showUrlInputArea(bool show)
{
    if (show) {
...
void TFTView_480x800::ui_event_chatNodeButton(lv_event_t *e)
{
    uint32_t nodeNum = (unsigned long)e->user_data;
...
void TFTView_480x800::ui_event_positionButton(lv_event_t *e)
{
...
void TFTView_480x800::ui_screen_event_cb(lv_event_t *e)
{
    if (THIS->activePanel == objects.map_panel) {
...
void TFTView_480x800::ui_event_arrow(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_navHome(lv_event_t *e)
{
    static bool ignoreClicked = false;
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::loadMap(void)
{
    if (!map) {
...
void TFTView_480x800::updateLocationMap(uint32_t num)
{
 ...
 */
void TFTView_480x800::addOrUpdateMap(uint32_t nodeNum, int32_t lat, int32_t lon)
{
...
void TFTView_480x800::removeFromMap(uint32_t nodeNum)
{
    auto it = nodeObjects.find(nodeNum);
    if (it == nodeObjects.end())
        return;
...
void TFTView_480x800::attribution(std::string url)
{
...
std::string TFTView_480x800::setUrlProvider(const char *style)
{
...
void TFTView_480x800::ui_event_mesh_detector(lv_event_t *e)
{
    THIS->ui_set_active(objects.settings_button, objects.mesh_detector_panel, objects.top_mesh_detector_panel);
}

void TFTView_480x800::ui_event_mesh_detector_start(_lv_event_t *e)
{
...
void TFTView_480x800::ui_event_signal_scanner(lv_event_t *e)
{
    if (currentPanel) {
...
void TFTView_480x800::ui_event_signal_scanner_node(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_signal_scanner_start(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (currentNode) {
        static bool ignoreClicked = false;
...
void TFTView_480x800::ui_event_trace_route(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_trace_route_to(lv_event_t *e)
{
    if (!spinnerButton) {
...
void TFTView_480x800::ui_event_trace_route_start(lv_event_t *e)
{
    if (!spinnerButton) {
        if (currentPanel) {
            time(&startTime);
...
void TFTView_480x800::ui_event_trace_route_node(lv_event_t *e)
{
    // navigate to node in node list
...
void TFTView_480x800::removeSpinner(void)
{
    if (spinnerButton) {
        lv_obj_delete(spinnerButton);
        spinnerButton = nullptr;
...
void TFTView_480x800::ui_event_node_details(lv_event_t *e)
{
    THIS->ui_set_active(objects.settings_button, objects.details_panel, objects.top_nodes_panel);
}

void TFTView_480x800::ui_event_statistics(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::ui_event_packet_log(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
...
void TFTView_480x800::packetDetected(const meshtastic_MeshPacket &p)
{
    uint32_t heard = 0;
    if (p.from != ownNode)
        heard = p.from;
...
void TFTView_480x800::writePacketLog(const meshtastic_MeshPacket &p)
{
...
void TFTView_480x800::updateStatistics(const meshtastic_MeshPacket &p)
{
    struct Stats {
        uint32_t id;
        uint16_t row;
...
void TFTView_480x800::ui_event_statistics_table(lv_event_t *e)
{
...
void TFTView_480x800::requestSetup(void)
{
 ...
 */
void TFTView_480x800::updateSignalStrength(int32_t rssi, float snr)
{
 ...
 */
uint32_t TFTView_480x800::preset2val(meshtastic_Config_LoRaConfig_ModemPreset preset)
{
 ...
 */
meshtastic_Config_LoRaConfig_ModemPreset TFTView_480x800::val2preset(uint32_t val)
{
 ...
 * UA_433\nMY_433\nMY_919\nSG_923\nPH_433\nPH_868\nPH_915\nANZ_433\nKZ_433\nKZ_863\nNP_865\nBR_902
 */
uint32_t TFTView_480x800::region2val(meshtastic_Config_LoRaConfig_RegionCode region)
{
...
meshtastic_Config_LoRaConfig_RegionCode TFTView_480x800::val2region(uint32_t val)
{
 ...
 */
uint32_t TFTView_480x800::role2val(meshtastic_Config_DeviceConfig_Role role)
{
 ...
 */
meshtastic_Config_DeviceConfig_Role TFTView_480x800::val2role(uint32_t val)
{
 ...
 */
uint32_t TFTView_480x800::language2val(meshtastic_Language lang)
{
    switch (lang) {
 ...
 */
meshtastic_Language TFTView_480x800::val2language(uint32_t val)
{
    switch (val) {
    case 0:
 ...
 */
void TFTView_480x800::setLocale(meshtastic_Language lang)
{
 ...
 */
void TFTView_480x800::setLanguage(meshtastic_Language lang)
{
 ...
 * @brief Set timeout
 */
void TFTView_480x800::setTimeout(uint32_t timeout)
{
    char buf[32];
    if (timeout == 0)
 ...
 */
void TFTView_480x800::setBrightness(uint32_t brightness)
{
    char buf[32];
 ...
 */
void TFTView_480x800::setTheme(uint32_t value)
{
 ...
 */
void TFTView_480x800::storeNodeOptions(void)
{
 ...
 */
void TFTView_480x800::eraseChat(uint32_t channelOrNode)
{
 ...
 */
void TFTView_480x800::clearChatHistory(void)
{
    for (auto &it : chats) {
 ...
 * @param e
 */
void TFTView_480x800::ui_event_ok(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
 ...
 * @param e
 */
void TFTView_480x800::ui_event_cancel(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED) {
        switch (THIS->activeSettings) {
        case TFTView_480x800::eSetup: {
            THIS->ui_set_active(objects.home_button, objects.home_panel, objects.top_panel);
            // lv_obj_add_flag(objects.initial_setup_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.home_button);
            break;
        }
        case TFTView_480x800::eUsername: {
            lv_obj_add_flag(objects.settings_username_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_user_button);
            break;
        }
        case TFTView_480x800::eDeviceRole: {
            lv_obj_add_flag(objects.settings_device_role_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_role_button);
            break;
        }
        case TFTView_480x800::eRegion: {
            lv_obj_add_flag(objects.settings_region_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_region_button);
            break;
        }
        case TFTView_480x800::eModemPreset: {
            lv_obj_add_flag(objects.settings_modem_preset_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_modem_preset_button);
            break;
        }
        case TFTView_480x800::eChannel: {
            delete[] THIS->channel_scratch;
            lv_obj_add_flag(objects.settings_channel_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_channel_button);
            break;
        }
        case TFTView_480x800::eWifi: {
            lv_obj_add_flag(objects.settings_wifi_panel, LV_OBJ_FLAG_HIDDEN);
            THIS->enablePanel(objects.home_panel);
            lv_group_focus_obj(objects.home_wlan_button);
            break;
        }
        case TFTView_480x800::eLanguage: {
            lv_obj_add_flag(objects.settings_language_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_language_button);
            break;
        }
        case TFTView_480x800::eScreenTimeout: {
            lv_obj_add_flag(objects.settings_screen_timeout_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_timeout_button);
            break;
        }
        ...
        case TFTView_480x800::eScreenBrightness: {
            lv_obj_add_flag(objects.settings_brightness_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_brightness_button);
        ...
        case TFTView_480x800::eTheme: {
            lv_obj_add_flag(objects.settings_theme_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_theme_button);
            break;
        }
        case TFTView_480x800::eInputControl: {
            lv_obj_add_flag(objects.settings_input_control_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_input_button);
            break;
        }
        case TFTView_480x800::eAlertBuzzer: {
            lv_obj_add_flag(objects.settings_alert_buzzer_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_alert_button);
            break;
        }
        case TFTView_480x800::eBackupRestore: {
            lv_obj_add_flag(objects.settings_backup_restore_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_backup_restore_button);
            break;
        }
        case TFTView_480x800::eReset: {
            lv_obj_add_flag(objects.settings_reset_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_reset_button);
            break;
        }
        case TFTView_480x800::eDisplayMode: {
            lv_obj_add_flag(objects.settings_reboot_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.basic_settings_reset_button);
            break;
        }
        case TFTView_480x800::eModifyChannel: {
            lv_obj_add_flag(objects.settings_modify_channel_panel, LV_OBJ_FLAG_HIDDEN);
            lv_group_focus_obj(objects.settings_channel0_button);
            THIS->enablePanel(objects.settings_channel_panel);
            THIS->activeSettings = eChannel;
...
void TFTView_480x800::ui_event_screen_timeout_slider(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_brightness_slider(lv_event_t *e)
{
    lv_obj_t *slider = lv_event_get_target_obj(e);
    char buf[20];
...
void TFTView_480x800::ui_event_frequency_slot_slider(lv_event_t *e)
{
    lv_obj_t *slider = lv_event_get_target_obj(e);
    char buf[40];
...
void TFTView_480x800::ui_event_modem_preset_dropdown(lv_event_t *e)
{
...
void TFTView_480x800::ui_event_setup_region_dropdown(lv_event_t *e) {}

// animations
void TFTView_480x800::ui_anim_node_panel_cb(void *var, int32_t v)
{
    lv_obj_set_height((lv_obj_t *)var, v);
}

void TFTView_480x800::ui_anim_radar_cb(void *var, int32_t r)
{
 ...
 * @param func
 */
void TFTView_480x800::showUserWidget(UserWidgetFunc createWidget)
{
...
void TFTView_480x800::handleAddMessage(char *msg)
{
 ...
 */
void TFTView_480x800::addMessage(lv_obj_t *container, uint32_t msgTime, uint32_t requestId, char *msg,
...
void TFTView_480x800::addNode(uint32_t nodeNum, uint8_t ch, const char *userShort, const char *userLong, uint32_t lastHeard,
...
void TFTView_480x800::setMyInfo(uint32_t nodeNum)
{
    ownNode = nodeNum;
}

void TFTView_480x800::setDeviceMetaData(int hw_model, const char *version, bool has_bluetooth, bool has_wifi, bool has_eth,
                                        bool can_shutdown)
{
}

void TFTView_480x800::addOrUpdateNode(uint32_t nodeNum, uint8_t channel, uint32_t lastHeard, const meshtastic_User &cfg)
{
 ...
 * @param viaMqtt
 */
// void TFTView_480x800::updateNode(uint32_t nodeNum, uint8_t ch, const char *userShort, const char *userLong, uint32_t lastHeard,
//                                  eRole role, bool hasKey, bool viaMqtt)
void TFTView_480x800::updateNode(uint32_t nodeNum, uint8_t ch, const meshtastic_User &cfg)
{
    db.user = cfg;
...
void TFTView_480x800::updatePosition(uint32_t nodeNum, int32_t lat, int32_t lon, int32_t alt, uint32_t sats, uint32_t precision)
{
...
void TFTView_480x800::updateDistance(uint32_t nodeNum, int32_t lat, int32_t lon)
{
 ...
 * @param airUtil
 */
void TFTView_480x800::updateMetrics(uint32_t nodeNum, uint32_t bat_level, float voltage, float chUtil, float airUtil)
{
    auto it = nodes.find(nodeNum);
    if (it != nodes.end()) {
        char buf[48];
...
void TFTView_480x800::updateEnvironmentMetrics(uint32_t nodeNum, const meshtastic_EnvironmentMetrics &metrics)
{
    auto it = nodes.find(nodeNum);
    if (it != nodes.end()) {
        char buf[50];
...
void TFTView_480x800::updateAirQualityMetrics(uint32_t nodeNum, const meshtastic_AirQualityMetrics &metrics)
{
    auto it = nodes.find(nodeNum);
...
void TFTView_480x800::updatePowerMetrics(uint32_t nodeNum, const meshtastic_PowerMetrics &metrics)
{
    auto it = nodes.find(nodeNum);
    if (it != nodes.end() && it->first != ownNode) {
        // TODO
 ...
 */
void TFTView_480x800::updateSignalStrength(uint32_t nodeNum, int32_t rssi, float snr)
{
    if (nodeNum != ownNode) {
        auto it = nodes.find(nodeNum);
        if (it != nodes.end()) {
...
void TFTView_480x800::updateHopsAway(uint32_t nodeNum, uint8_t hopsAway)
{
    if (nodeNum != ownNode) {
        auto it = nodes.find(nodeNum);
        if (it != nodes.end()) {
...
void TFTView_480x800::updateConnectionStatus(const meshtastic_DeviceConnectionStatus &status)
{
...
void TFTView_480x800::onTextMessageCallback(const ResponseHandler::Request &req, ResponseHandler::EventType evt, int32_t result)
{
...
void TFTView_480x800::onPositionCallback(const ResponseHandler::Request &req, ResponseHandler::EventType evt, int32_t) {}

void TFTView_480x800::onTracerouteCallback(const ResponseHandler::Request &req, ResponseHandler::EventType evt, int32_t) {}

/**
 * handle response from routing
 */
void TFTView_480x800::handleResponse(uint32_t from, const uint32_t id, const meshtastic_Routing &routing,
 ...
 * Signal scanner
 */
void TFTView_480x800::scanSignal(uint32_t scanNo)
{
...
void TFTView_480x800::handlePositionResponse(uint32_t from, uint32_t request_id, int32_t rx_rssi, float rx_snr, bool isNeighbor)
{
 ...
 */
void TFTView_480x800::handleTraceRouteResponse(const meshtastic_Routing &routing)
{
...
void TFTView_480x800::handleResponse(uint32_t from, uint32_t id, const meshtastic_RouteDiscovery &route)
{
...
void TFTView_480x800::addNodeToTraceRoute(uint32_t nodeNum, lv_obj_t *panel)
{
 ...
 */
void TFTView_480x800::purgeNode(uint32_t nodeNum)
{
    if (nodeCount <= 1)
        return;
 ...
 * @return false
 */
bool TFTView_480x800::applyNodesFilter(uint32_t nodeNum, bool reset)
{
    lv_obj_t *panel = nodes[nodeNum];
    bool hide = false;
...
void TFTView_480x800::messageAlert(const char *alert, bool show)
{
 ...
 * @param ack
 */
void TFTView_480x800::handleTextMessageResponse(uint32_t channelOrNode, const uint32_t id, bool ack, bool err)
{
...
void TFTView_480x800::packetReceived(const meshtastic_MeshPacket &p)
{
...
void TFTView_480x800::notifyConnected(const char *info)
{
...
void TFTView_480x800::notifyDisconnected(const char *info)
{
    if (state == MeshtasticView::eBooting) {
        updateBootMessage(info);
    } else {
...
void TFTView_480x800::notifyResync(bool show)
{
    if (controller->isStandalone()) {
        if (show)
            notifyReboot(true);
...
void TFTView_480x800::notifyReboot(bool show)
{
...
void TFTView_480x800::notifyShutdown(void)
{
    messageAlert(_("Shutting down ..."), true);
}

void TFTView_480x800::blankScreen(bool enable)
{
...
void TFTView_480x800::screenSaving(bool enabled)
{
    if (enabled) {
...
bool TFTView_480x800::isScreenLocked(void)
{
    return screenLocked && !screenUnlockRequest;
}

void TFTView_480x800::updateChannelConfig(const meshtastic_Channel &ch)
{
...
void TFTView_480x800::updateGroupChannel(uint8_t chId)
{
    static lv_obj_t *btn[c_max_channels] = {objects.channel_button0, objects.channel_button1, objects.channel_button2,
                                            objects.channel_button3, objects.channel_button4, objects.channel_button5,
                                            objects.channel_button6, objects.channel_button7};
...
void TFTView_480x800::updateDeviceConfig(const meshtastic_Config_DeviceConfig &cfg)
{
...
void TFTView_480x800::updatePositionConfig(const meshtastic_Config_PositionConfig &cfg)
{
...
void TFTView_480x800::updatePowerConfig(const meshtastic_Config_PowerConfig &cfg)
{
    db.config.power = cfg;
    db.config.has_power = true;
}

void TFTView_480x800::updateNetworkConfig(const meshtastic_Config_NetworkConfig &cfg)
{
...
void TFTView_480x800::updateDisplayConfig(const meshtastic_Config_DisplayConfig &cfg)
{
...
void TFTView_480x800::updateLoRaConfig(const meshtastic_Config_LoRaConfig &cfg)
{
    db.config.lora = cfg;
...
void TFTView_480x800::showLoRaFrequency(const meshtastic_Config_LoRaConfig &cfg)
{
    char loraFreq[48];
    if (!cfg.region) {
...
void TFTView_480x800::setBellText(bool banner, bool sound)
{
    if (banner && sound) {
 ...
 */
void TFTView_480x800::setChannelName(const meshtastic_Channel &ch)
{
    char buf[40];
    if (ch.role == meshtastic_Channel_Role_PRIMARY) {
...
void TFTView_480x800::backup(uint32_t option)
{
...
void TFTView_480x800::restore(uint32_t option)
{
#if defined(HAS_SDCARD) || defined(HAS_SD_MMC) || defined(ARCH_PORTDUINO)
    meshtastic_Config_SecurityConfig_public_key_t &pubkey = db.config.security.public_key;
    meshtastic_Config_SecurityConfig_private_key_t &privkey = db.config.security.private_key;
 ...
 */
uint32_t TFTView_480x800::timestamp(char *buf, uint32_t datetime, bool update)
{
 ...
 */
int32_t TFTView_480x800::signalStrength2Percent(int32_t rx_rssi, float rx_snr)
{
#if defined(USE_SX127x)
...
void TFTView_480x800::updateBluetoothConfig(const meshtastic_Config_BluetoothConfig &cfg, uint32_t id)
{
...
void TFTView_480x800::updateSessionKeyConfig(const meshtastic_Config_SessionkeyConfig &cfg)
{
    // TODO
}
...
void TFTView_480x800::updateMQTTModule(const meshtastic_ModuleConfig_MQTTConfig &cfg)
{
...
void TFTView_480x800::updateExtNotificationModule(const meshtastic_ModuleConfig_ExternalNotificationConfig &cfg)
{
...
void TFTView_480x800::updateRingtone(const char rtttl[231])
{
...
void TFTView_480x800::updateTime(uint32_t timeVal)
{
    time_t localtime;
    time(&localtime);
 ...
 * @param channel
 */
lv_obj_t *TFTView_480x800::newMessageContainer(uint32_t from, uint32_t to, uint8_t ch)
{
 ...
 */
void TFTView_480x800::newMessage(uint32_t from, uint32_t to, uint8_t ch, const char *msg, uint32_t &msgTime, bool restore)
{
 ...
 * @param msg
 */
void TFTView_480x800::newMessage(uint32_t nodeNum, lv_obj_t *container, uint8_t ch, const char *msg)
{
    lv_obj_t *hiddenPanel = lv_obj_create(container);
    lv_obj_set_width(hiddenPanel, lv_pct(100));
 ...
 */
void TFTView_480x800::restoreMessage(const LogMessage &msg)
{
 ...
 * @param ch
 */
void TFTView_480x800::addChat(uint32_t from, uint32_t to, uint8_t ch)
{
...
void TFTView_480x800::highlightChat(uint32_t from, uint32_t to, uint8_t ch)
{
    uint32_t index = ((to == UINT32_MAX || from == 0) ? ch : from);
    auto it = chats.find(index);
    if (it != chats.end()) {
...
void TFTView_480x800::updateActiveChats(void)
{
    char buf[48];
 ...
 */
void TFTView_480x800::notifyRestoreMessages(int32_t percentage)
{
    lv_bar_set_value(objects.message_restore_bar, percentage, LV_ANIM_OFF);
}

void TFTView_480x800::notifyMessagesRestored(void)
{
 ...
 */
void TFTView_480x800::showMessagePopup(uint32_t from, uint32_t to, uint8_t ch, const char *name)
{
    if (name) {
        static char buf[64];
...
void TFTView_480x800::hideMessagePopup(void)
{
    lv_obj_add_flag(objects.msg_popup_panel, LV_OBJ_FLAG_HIDDEN);
}
 ...
 * @param ch
 */
void TFTView_480x800::showMessages(uint8_t ch)
{
    if (!messagesRestored) {
 ...
 * @param nodeNum
 */
void TFTView_480x800::showMessages(uint32_t nodeNum)
{
    lv_obj_add_flag(activeMsgContainer, LV_OBJ_FLAG_HIDDEN);
 ...
 * @param textArea
 */
void TFTView_480x800::showKeyboard(lv_obj_t *textArea)
{
...
void TFTView_480x800::hideKeyboard(lv_obj_t *panel)
{
    lv_area_t kb_coords;
    lv_obj_get_coords(objects.keyboard, &kb_coords);
    uint32_t kb_h = kb_coords.y2 - kb_coords.y1;
 ...
 */
void TFTView_480x800::resetKeyboardSlide(void)
{
...
lv_obj_t *TFTView_480x800::showQrCode(lv_obj_t *parent, const char *data)
{
 ...
 */
void TFTView_480x800::enablePanel(lv_obj_t *panel)
{
 ...
 */
void TFTView_480x800::disablePanel(lv_obj_t *panel)
{
 ...
 */
void TFTView_480x800::setGroupFocus(lv_obj_t *panel)
{
 ...
 */
void TFTView_480x800::setInputGroup(void)
{
...
void TFTView_480x800::setInputButtonLabel(void)
{
...
void TFTView_480x800::removeNode(uint32_t nodeNum)
{
    auto it = nodes.find(nodeNum);
    if (it != nodes.end()) {
    }
...
void TFTView_480x800::setNodeImage(uint32_t nodeNum, eRole role, bool unmessagable, lv_obj_t *img)
{
    uint32_t bgColor, fgColor;
    std::tie(bgColor, fgColor) = nodeColor(nodeNum);
    if (unmessagable) {
...
void TFTView_480x800::updateNodesStatus(void)
{
    char buf[40];
 ...
 */
void TFTView_480x800::updateNodesFiltered(bool reset)
{
 ...
 * @param nodeNum
 */
void TFTView_480x800::updateLastHeard(uint32_t nodeNum)
{
    auto it = nodes.find(nodeNum);
    if (it != nodes.end() && it->second) {
 ...
 *
 */
void TFTView_480x800::updateAllLastHeard(void)
{
    uint16_t online = 0;
    time_t lastHeard;
    for (auto it : nodes) {
...
void TFTView_480x800::updateUnreadMessages(void)
{
    char buf[64];
    if (unreadMessages > 0) {
 ...
 *
 */
void TFTView_480x800::updateTime(void)
{
    char buf[80];
    time_t curr_time;
    time(&curr_time);
 ...
 */
void TFTView_480x800::armSDCardStatsPoll(void)
{
    ...
    lv_timer_t *poll = lv_timer_create(
        [](lv_timer_t *) {
            pollPending = false;
            TFTView_480x800::instance()->refreshSDCardStats();
        },
        10 * 1000, NULL);
    if (!poll)
...
void TFTView_480x800::refreshSDCardStats(void)
{
#if defined(HAS_SDCARD) || defined(SENSECAP_INDICATOR)
...
void TFTView_480x800::formatSDCardLabel(char *buf, size_t len)
{
...
void TFTView_480x800::formatSDCard(void)
{
    if (sdCard) {
        delete sdCard;
        sdCard = nullptr;
 ...
 */
void TFTView_480x800::ejectSDCard(void)
{
#if defined(HAS_SDCARD) || defined(SENSECAP_INDICATOR)
...
void TFTView_480x800::updateFreeMem(void)
{
...
void TFTView_480x800::task_handler(void)
{
